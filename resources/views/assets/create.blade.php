    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Isi form berikut untuk menambahkan asset</p>
            </div>
        </div>
    </x-slot>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('brand') }}"
                                       class="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-blue focus:ring-brand-blue transition"
                                       placeholder="Contoh: HP, Dell, Lenovo">
                                @error('brand')
                                    <p class="text-brand-red text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="condition" 
                                    ...
                                    @foreach($conditions as $cond)
                                        <option value="{{ $cond }}" {{ old('condition', 'bagus') == $cond ? 'selected' : '' }}>
                                            {{ ucfirst($cond) }}
                                        </option>
                                    @endforeach
                                </select>
