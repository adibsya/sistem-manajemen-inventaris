    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Kelola kategori asset</p>
            </div>
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 mb-2">Belum ada kategori.</p>
                                            <a href="{{ route('categories.create') }}" class="text-brand-blue hover:text-brand-blue/80 font-medium">
