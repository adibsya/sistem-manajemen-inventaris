<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('maintenance-logs.index') }}" class="text-brand-blue hover:text-brand-blue/80">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Catat tindakan perbaikan yang telah dilakukan</p>
            </div>
        </div>
    </x-slot>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="cost" class="block text-sm font-semibold text-gray-700 mb-2">
                                    💰 Biaya Perbaikan (Rp) <span class="text-brand-red">*</span>
                                </label>
                                <div class="relative">
